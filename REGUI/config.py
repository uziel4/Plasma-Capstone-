...
# GPIO 5 | Pin físico 29 | IN1 | Mechanical Roughing Pump
ROUGHING_GPIO = 5

# GPIO 6 | Pin físico 31 | IN3 | Gas Mass Control Solenoid Valve
MASS_FLOW_GPIO = 6

# GPIO 13 | Pin físico 33 | Active buzzer for timer alarm
BUZZER_GPIO = 13
